...
from src.api.register_products_paged import register_products_paged
from src.api.register_openapi_route import register_openapi_route
...
register_products_paged(app)
register_openapi_route(app)
